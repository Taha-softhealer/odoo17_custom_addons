...
patch(PosStore.prototype, {
    async _processData(loadedData){
        ...
        this.sh_available_pack_pricelist_lines_id = loadedData['sh_available_pack_pricelist_lines_id']
        this.sh_get_one_product_free_id = loadedData['sh_get_one_product_free_id']
    },
    ...
    async sh_check_quantity() {
        ...
        if (
            ...
            reward_lines_id = happy_hours_id.sh_packlist_ids;
            reward_lines=this.sh_available_pack_pricelist_lines_id[reward_lines_id]
    ...
    async _sh_check_quantity(reward_lines, buyXget1) {
        ...
        for (let j = 0; j < reward_lines.length; j++) {
            ...
            if (
                pack.sh_product_id == SelectedLine?.product.id &&
